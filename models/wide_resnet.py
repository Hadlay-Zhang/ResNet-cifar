...
def Wide_ResNet_18(**kwargs):
    """
      - conv_kernel_sizes: [3, 3, 3] (BasicBlock use 3 * 3 convolutions)
      - num_blocks: [4, 4, 3]
      - shortcut_kernel_sizes: [1, 1, 1] (downsampling using 1 * 1)
      - avg_pool_kernel_size: 8
    """
    channels = [64, 128, 256] 
    layers = [4, 4, 3]        
    return ResNet(BasicBlock, channels, layers, **kwargs)
