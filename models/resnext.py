...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, num_group, stride=1, downsample=None):
...
class ResNeXt(nn.Module):
    ...
    def __init__(self, block, channels, layers, num_classes=10, num_group=16):
        self.inplanes = 64
        ...
        self.layer1 = self._make_layer(block, channels[0], layers[0], num_group)
        self.layer2 = self._make_layer(block, channels[1], layers[1], num_group, stride=2)
        self.layer3 = self._make_layer(block, channels[2], layers[2], num_group, stride=2)
        self.layer4 = self._make_layer(block, channels[3], layers[3], num_group, stride=2)
    ...
    def _make_layer(self, block, planes, blocks, num_group, stride=1):
        ...
        layers = []
        layers.append(block(self.inplanes, planes, num_group, stride, downsample))
